...
static void gui_create(void)
{
    ...
    lv_obj_set_pos(btn_enable, LV_DPI/4, LV_DPI/4);

    /*Create a sliders*/
    lv_obj_t * slider = lv_slider_create(lv_scr_act(), NULL);
    lv_obj_set_size(slider, LV_DPI, LV_DPI / 3);
    lv_obj_align(slider, btn_enable, LV_ALIGN_OUT_RIGHT_MID, LV_DPI / 4, 0);
    ...
    lv_obj_align(ddlist, btn_enable, LV_ALIGN_OUT_BOTTOM_LEFT, 0, LV_DPI / 4);
...
static void kaypad_create(void)
{
   uint16_t buttonWidth = (240 - (3 * LV_DPI/4))/2;
    ...
    lv_btn_set_fit(btn_next, false, true);
    lv_obj_set_width(btn_next, buttonWidth);
    ...
    lv_obj_align(btn_dec, btn_next, LV_ALIGN_OUT_TOP_LEFT, 0, -LV_DPI/4);
