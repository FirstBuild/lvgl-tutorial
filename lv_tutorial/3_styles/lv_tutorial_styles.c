...
void lv_tutorial_styles(void)
{
    ...
    /*Create a simple objects*/
    lv_obj_t * obj22;
    obj22 = lv_obj_create(lv_scr_act(), NULL);
    lv_obj_align(obj22, obj2, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 20);    /*Align next to the previous object*/
    lv_obj_set_style(obj22, &lv_style_pretty_color);                   /*Set built in style*/

    /* Add a label to the object.
     * Labels by default inherit the parent's style */
    label = lv_label_create(obj22, NULL);
    //lv_label_set_text(label, "Pretty\nstyle");
    lv_label_set_text(label, "Color");
    lv_obj_align(label, obj22, LV_ALIGN_CENTER, 0, 0);
    ...
    style_new.text.color = LV_COLOR_BLACK;                 /*Red text color */
    ...
    lv_obj_align(obj3, obj1, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 20);
    ...
    lv_label_set_text(label, "New");
    //lv_obj_align(label, NULL, LV_ALIGN_CENTER, 0, 0);
    lv_obj_align(label, obj3, LV_ALIGN_CENTER, 0, 0);
    ...
    lv_obj_set_size(bar, 240 - lv_obj_get_x(obj3) * 2, 30);
    lv_obj_align(bar, obj3, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 20);
