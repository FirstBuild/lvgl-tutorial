...
void lv_tutorial_objects(void)
{
    ...
    printf("Width: %d\r\n", lv_obj_get_width(lv_scr_act()));   /*Set the size*/
    ...
    lv_obj_align(label, scr, LV_ALIGN_IN_TOP_MID, 0, 20);  /*Align to the top*/
    ...
    lv_obj_set_pos(btn1, 10, lv_obj_get_y(label) + lv_obj_get_height(label) + 20);
    ...
    lv_obj_align(btn2, btn1, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 20);    /*Align next to the prev. button.*/
    ...
    lv_obj_align(slider, btn2, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 20);                /*Align below the first button*/
    lv_obj_set_size(slider, 
          lv_obj_get_width(lv_scr_act())-(lv_obj_get_x(lv_obj_get_parent(slider)))*2 - lv_obj_get_x(slider)*2, 
          LV_DPI / 3);   /*Set the size*/
    ...
    lv_obj_align(ddlist, slider, LV_ALIGN_OUT_BOTTOM_RIGHT, 0, 0);         /*Align next to the slider*/
    ...
    printf("Slider x    : %3d\r\n", lv_obj_get_x(slider));
    printf("Slider width: %3d\r\n", lv_obj_get_width(slider));
    printf("DD x        : %3d\r\n", lv_obj_get_x(ddlist));
    printf("DD width    : %3d\r\n", lv_obj_get_width(ddlist));
    lv_obj_set_x(ddlist, lv_obj_get_x(slider) + lv_obj_get_width(slider) - lv_obj_get_width(ddlist));
